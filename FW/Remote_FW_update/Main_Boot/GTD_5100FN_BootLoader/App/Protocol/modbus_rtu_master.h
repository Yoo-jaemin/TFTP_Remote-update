...
MODBUS_RTU_MASTER_EXT void Cartridge_BootJump_Write_Packet_Send( MODBUS_MasterHandleType *pModbus );
MODBUS_RTU_MASTER_EXT void Cavity_BootJump_Write_Packet_Send( MODBUS_MasterHandleType *pModbus );
/* End Function */
