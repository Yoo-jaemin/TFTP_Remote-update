...
static void MODBUS_TCP_Write_Single_Coil_Slave( MODBUS_TCP_SlaveHandleType *pSlave )
{
	...
	switch( RefBi ){
		...
		case 5: pSlave->pReg_0x[RefBy].Bit._5 = Set; break;     // pSlave->pReg_0x[0].Bit._5 = Set; -> main fw update
		case 6: pSlave->pReg_0x[RefBy].Bit._6 = Set; break;     // pSlave->pReg_0x[0].Bit._6 = Set  -> ct
		case 7: pSlave->pReg_0x[RefBy].Bit._7 = Set; break;     // pSlave->pReg_0x[0].Bit._7 = Set  -> ir
	}
...
static void MODBUS_TCP_Write_Single_Register_Slave( MODBUS_TCP_SlaveHandleType *pSlave )
{
	...
	switch( Add ){
		...
		case MODBUS_40031:
		case MODBUS_40032:  
                case MODBUS_40090:  // fw update reg
