...
/* Start Enum */
enum {
	CARTRIDGE_MODEL_PROTO,
	CARTRIDGE_MODEL_5000N,
	CARTRIDGE_MODEL_5100FN,
	CARTRIDGE_MODEL_5200N,
	CARTRIDGE_MODEL_5200FN,
	CARTRIDGE_MODEL_5200N_DUAL,
	CARTRIDGE_MODEL_5200FN_DUAL
};
...
CARTRIDGE_EXT void Cartridge_BootJump_Write_Packet_Send( MODBUS_MasterHandleType *pModbus ); 
/* End Function */
